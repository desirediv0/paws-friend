...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, we provide 24/7 emergency pet care services. Our experienced veterinarians and pet care professionals are available round the clock to handle any emergency situations. Call us immediately at +91 8800682777 for urgent pet care needs.",
  },
  {
...
export default function PetCareInfo() {
  ...
  return (
    <div className="min-h-screen" >
      ...
      <div className="py-8 md:py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-[#0e134d] max-w-4xl mx-auto leading-relaxed font-semibold">
      ...
      {/* Benefits Section */}
      <div className="md:py-16 px-4 ">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-black mb-4">
              Benefits Of In-House Pet Care Services
            </h2>
            <p className="text-lg text-[#0e134d] max-w-4xl mx-auto leading-relaxed font-semibold">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-[#0e134d] mb-8 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-[#0e134d] leading-relaxed">
      ...
      <div className="md:py-16 px-4 ">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#0e134d]">

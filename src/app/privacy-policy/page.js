    ...
    return (
        <div className="min-h-screen bg-gray-100 py-24 px-2 sm:px-4 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
                ...
                <h2 className="text-2xl font-semibold mb-4 text-gray-800">1. Usage of Information</h2>
                ...
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <li>to provide You pet care Services including veterinary care, pet grooming, lab testing, pet training, emergency care, and vaccinations;</li>
                    ...
                    <li>for providing customized user relevant suggestions / Services related to pet care;</li>
                    <li>to communicate with You through mail, e-mail, telephone, or through any other mode of communication, in connection with the pet care Services, or other products or services of the Company;</li>
                    <li>to respond to Your comments, requests, reviews, and questions and provide better pet care Services;</li>
                    ...
                    <li>for internal purposes such as auditing, data analysis, research and improvement relating to the Platform or the pet care Services;</li>
                    <li>for promotion and marketing purposes related to our pet care services;</li>
                    <li>for sharing such information with any third party, including any service providers and any of Our group companies, in the course of providing the pet care Services through the Platform;</li>
                    ...
                    <li>to coordinate emergency pet care services when needed.</li>
                </ul>

                <p className="mb-4 text-gray-700">
                    The data gathered from You may also be used for any reason incidental to the reasons listed above; and for any other purpose with Your consent. We use Your Personal Information to send You promotional emails about our pet care services, however, We will provide You the ability to opt-out of receiving such emails from Us. However, You will not be able to opt-out of receiving administrative messages, customer service responses or other transactional communications related to your pet care services. Unless and until, You explicitly give Your consent to Us, to do so, We will not share Your Personal Information with another user of the Platform and vice versa.
                </p>

                <h2 className="text-2xl font-semibold mb-4 text-gray-800">2. Collection of Information by Third-Party Sites and Advertisers</h2>
                ...
                <h2 className="text-2xl font-semibold mb-4 text-gray-800">3. Disclosure to Third Parties</h2>

                <p className="mb-4 text-gray-700">
                    The Company may disclose Your information including Personal Information, if required to do so by law and if such action is necessary to: (a) comply with a legal obligation or with laws, regulatory requirements and to respond to lawful requests and legal process; (b) protect and defend the rights or property of the Company, and other users of the Platform including to enforce agreements, policies and Terms of Service; (c) protect the personal safety of the Company, the users of the Platform, their pets, or any person, in an emergency; (d) protect the Company from incurring any legal liability; (e) firms representing the Company in judicial proceedings and/or any legal, accounting and auditing firms providing services to the Company; and (f) for reasons incidental to the above. In such an event the Company shall be under no obligation to inform You or seek Your approval or consent.
                </p>

                <p className="mb-4 text-gray-700">
                    The Company may disclose Your Personal Information to: (i) any third party to facilitate the provision of the pet care Services including the Platform; and (ii) any third parties who provide services, such as auditing, data analysis, platform improvement and assistance with delivery of pet care services, relevant marketing messages and advertisements. If You provide a mobile phone number and/or e-mail address, the Company or the third-party service providers or the persons authorized by them, may send You text messages/e-mails in relation to Your use of the Platform and pet care services. The Company contractually requires these third parties to keep such information confidential and use it only for the purposes for which the Company discloses it to them. These third parties may view, edit, or set their own cookies or may place beacons on Your personal information.
                </p>
                ...
                <h2 className="text-2xl font-semibold mb-4 text-gray-800">4. Security</h2>
                ...
                <p className="mb-4 text-gray-700">
                    Where the use of Your information is based on consent, You can withdraw this consent at any time without affecting the lawfulness of processing based on consent before its withdrawal. In the event You desire to withdraw Your consent or delete Your Personal Information collected by the Company, You can do so by contacting Us at connect@pawsfriend.in. If You are aware of any changes or inaccuracies in Your information, You should inform the Company of such changes so that the records of the Company may be updated or corrected. The Company will respond to Your request as soon as possible under relevant regulation.
                </p>

                <p className="mb-4 text-gray-700">
                    The Company will retain Your personal information as long as needed to provide the pet care Services, or as required or permitted by applicable laws.
                </p>

                <h2 className="text-2xl font-semibold mb-4 text-gray-800">7. Grievances</h2>
                ...
                <ul className="list-none pl-0 mb-4 text-gray-700 space-y-1">
                    ...
                    <li><strong>Address:</strong> 314, Sec 23, Gurgaon, Haryana 122017</li>
                </ul>
                ...
                <p className="mb-4 text-gray-700">
                    The Grievance Redressal Officer shall acknowledge the complaint within twenty four hours and dispose off such complaint within a period of fifteen days from the date of its receipt.
                </p>

                <h2 className="text-2xl font-semibold mb-4 text-gray-800">8. Amendments</h2>
